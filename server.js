...
const config = {
    ...
    title: 'Charge As A Service',
    dataMapping: {
        temperature: {
            graphTitle: 'Charge-Status',
            yAxisLabel: 'Available charge (Watt)',
            xAxisLabel: 'Time',
            minY: 50, // suggested numbers, if numbers out of this range are received the graph will adjust
            maxY: 800,
            numberOfEvents: 4, // no. of events we send to the client
            data: payload => payload.payload_fields.Sensor1
        },
